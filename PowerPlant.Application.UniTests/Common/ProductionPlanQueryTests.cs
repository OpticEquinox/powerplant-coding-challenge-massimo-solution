...
namespace PowerPlant.Application.UniTests.Common;

public static class ProductionPlanQueryTests
{
    public static ProductionPlanQuery GetDefaultPowerPlanInput()
    {
        return new ProductionPlanQuery
        {
            Load = 910M,
            Fuels = new Fuels
            {
